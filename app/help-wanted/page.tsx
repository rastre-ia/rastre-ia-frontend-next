...
export default function HelpWanted() {
  ...
  const handleSubmitResponse = (requestId: number, response: string) => {
    console.log(`Resposta enviada para a solicitação ${requestId}:`, response);
  };
        ...
        <div className="grid gap-6 md:grid-cols-3">
          <Card className="md:col-span-2">
            <CardHeader>
              ...
              <CardDescription>
                Essas solicitações combinam com sua experiência e localização
              </CardDescription>
            </CardHeader>
            <CardContent>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center">
                          ...
                          <span className="font-semibold">
                            {request.matchScore}% de Combinação
                          </span>
                        </div>
                        <Dialog>
                            ...
                            <form
                              onSubmit={(e) => {
                                ...
                                const response = (e.target as HTMLFormElement)
                                  .response.value;
                                handleSubmitResponse(request.id, response);
          ...
          {user && (
            <Card>
              <CardHeader>
                ...
                <CardDescription>Seu impacto nas investigações</CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <div>
                  <h4 className="font-semibold mb-2">Sua Experiência</h4>
              ...
              <CardFooter>
                <p className="text-sm text-muted-foreground">
                  Suas contribuições estão fazendo uma diferença significativa
                  nas investigações. Obrigado pelo seu apoio contínuo!
                </p>
              </CardFooter>
            </Card>
          )}
